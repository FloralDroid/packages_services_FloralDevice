...
class DisplayTopologyControlHandler final : public control::ControlRequestHandler {
  public:
    explicit DisplayTopologyControlHandler(std::shared_ptr<DisplayTopologyController> controller);
  ...
  private:
    const std::shared_ptr<DisplayTopologyController> controller_;
};
