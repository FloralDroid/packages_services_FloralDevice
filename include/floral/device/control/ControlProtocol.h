...
enum class ControlCommandId : uint16_t {
    ...
    kSetPowerControl = 0x0600,
    kReleasePowerControl = 0x0601,
    kGetPowerSnapshot = 0x0602,
    kGetPowerCapabilities = 0x0603,
    kSetRadioRegistration = 0x0700,
    kSetRadioSignal = 0x0701,
    kReplaceRadioCells = 0x0702,
    kSetSimState = 0x0703,
    kInjectIncomingCall = 0x0704,
    kSetRadioCallState = 0x0705,
    kInjectIncomingSms = 0x0706,
    kReleaseRadioControl = 0x0707,
    kPushRadioSampleBatch = 0x0708,
    kGetRadioProfile = 0x0710,
    kGetRadioSnapshot = 0x0711,
    kListRadioCells = 0x0712,
    kListRadioCalls = 0x0713,
    kListRadioSmsEvents = 0x0714,
    kGetRadioCapabilities = 0x0715,
    kSetWifiEnabled = 0x0800,
    kReplaceWifiAccessPoints = 0x0801,
    kSetWifiConnection = 0x0802,
    kSetWifiLink = 0x0803,
    kReleaseWifiControl = 0x0804,
    kPushWifiSampleBatch = 0x0805,
    kGetWifiProfile = 0x0810,
    kGetWifiSnapshot = 0x0811,
    kListWifiAccessPoints = 0x0812,
    kGetWifiCapabilities = 0x0813,
};
