...
struct ImportedFrameResult {
    aidl::floral::device::display::FrameStatus status =
            aidl::floral::device::display::FrameStatus::INTERNAL_ERROR;
...
class FrameConsumerBackend {
  public:
    ...
    virtual aidl::floral::device::display::FrameStatus RegisterBuffer(
...
class FrameConsumerService final : public aidl::floral::device::display::BnFrameConsumer {
  public:
    ...
    ndk::ScopedAStatus registerBuffer(
            ...
            aidl::floral::device::display::FrameStatus* result) override;
