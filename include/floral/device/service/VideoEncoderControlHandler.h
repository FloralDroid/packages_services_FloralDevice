...
class VideoEncoderControlHandler final : public control::ControlRequestHandler {
  public:
    explicit VideoEncoderControlHandler(std::shared_ptr<VideoEncoderControl> control);
  ...
  private:
    const std::shared_ptr<VideoEncoderControl> control_;
};
